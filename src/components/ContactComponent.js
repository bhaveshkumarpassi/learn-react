...
import { Breadcrumb, BreadcrumbItem, Form, FormGroup, Label, Input, Col,
...
class Contact extends Component {
    ...
    validate(firstname,lastname,telnum,email) {
        ...
        if(this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = "Tel. number should only contain numbers between 0-9";
        
        if(this.state.touched.email && email.split('').filter(x => x === '@').length !== 1)
            errors.email = "email address should contain an @ sign";
